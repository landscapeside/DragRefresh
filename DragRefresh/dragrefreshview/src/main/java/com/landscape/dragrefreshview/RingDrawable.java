 ...
 */
public class RingDrawable extends Drawable implements Drawable.Callback, Animatable {
...
//        ViewCompat.setLayerType(this, ViewCompat.LAYER_TYPE_SOFTWARE, circle.getPaint());
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int x = RingDrawable.this.getBounds().centerX();
            final int y = RingDrawable.this.getBounds().centerY();
